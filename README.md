...
Platforms (Airbnb, Booking.com) collect the taxe de séjour on our behalf —
...
and verify declaractions based on actual booking status.
...
4. Computes the net (HT) and taxe de séjour using the same per-night rounding as the site.
